<?php
	...
	define('SQL_SELECT_USER_BY_OAUTH_TOKEN', "SELECT * FROM " . TABLE_USERS . " WHERE oauth_token=?");
//	define('SQL_SELECT_USER_BY_SESSION_AND_ID', "SELECT * FROM " . TABLE_USERS . " WHERE sid=? AND id=?");
	define('SQL_SELECT_USER_BY_ID', "SELECT * FROM " . TABLE_USERS . " WHERE id=?");
	// Modify
